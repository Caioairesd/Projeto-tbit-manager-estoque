...
class menu_admin:
    ...
    def create_widget(self):
        ...
        fornecedor_button = ctk.CTkButton(self.root, text='Fornecedor', text_color='black',width=110, height= 45, fg_color= '#404040', bg_color= 'gray',command=self.abrir_tela_fornecedor_admin)
        fornecedor_button.place(x=760, y=460)

        produto_button = ctk.CTkButton(self.root, text='Produtos', text_color='black',width=110, height= 45, fg_color= '#404040', bg_color= 'gray',command=self.abrir_tela_produto_admin)
        produto_button.place(x=760, y=520)

        cliente_button = ctk.CTkButton(self.root, text='Cliente', text_color='black',width=110, height= 45, fg_color= '#404040', bg_color= 'gray',command=self.abrir_tela_cliente)
        cliente_button.place(x=760, y=580)
        
        estoque_button = ctk.CTkButton(self.root, text='Estoque', text_color='black',width=110, height= 45, fg_color= '#404040', bg_color= 'gray',command=self.abrir_tela_estoque)
        estoque_button.place(x=980, y=400)

        pedido_button = ctk.CTkButton(self.root, text='Pedido', text_color='black',width=110, height= 45, fg_color= '#404040', bg_color= 'gray',command=self.abrir_tela_pedido)
        pedido_button.place(x=980, y=460)

        reabastecimento_button = ctk.CTkButton(self.root, text='Reabastecimento',text_color='black', width=110, fg_color= '#404040', bg_color= 'gray',height= 45, command=self.abrir_tela_reabastecimento)
        reabastecimento_button.place(x=980, y=520)

        dashboard_button = ctk.CTkButton(self.root, text='Dashboard', text_color='black',width=110, height= 45,fg_color= '#404040', bg_color= 'gray', command=self.abrir_tela_dashboard)
        dashboard_button.place(x=980, y=580)

        logout_button = ctk.CTkButton(self.root, text='Voltar',text_color='black', width=90, height= 40,fg_color= '#404040', bg_color= 'gray', command=self.logout_admin)
