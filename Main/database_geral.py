        ...
        try:
            ...
            comandos_sql = [
                ...
                """
                    ...
                    ( 'Monitor 24\"', 'Monitor LG 24\" Full HD IPS', 'Monitores', 52, 899.90, 4),
                    ( 'SSD 480GB', 'SSD Kingston 480GB SATA', 'Armazenamento', 145, 249.90, 5),
                    ...
                    ( 'Pendrive Kingston', 'Pendrive Kingston 64GB USB 3.0', 'Armazenamento', 192, 59.90, 13),
                    ( 'Placa de Vídeo GTX 1650', 'Placa de vídeo GTX 1650 GDDR6', 'Placas de Vídeo', 22, 1299.90, 14),
                    ( 'Processador Intel i5 10ª geração', 'Processador Intel Core i5 10400F', 'Processadores', 42, 999.90, 15),
                    ( 'Placa-Mãe ATX LGA 1200', 'Placa-mãe ATX LGA 1200 para Intel', 'Placas-Mãe', 32, 699.90, 16),
                    ( 'Memória RAM DDR4 8GB', 'Memória RAM 8GB DDR4 3200MHz', 'Memória RAM', 112, 199.90, 17),
                    ( 'SSD NVMe 500GB', 'SSD NVMe 500GB PCIe Gen3', 'Armazenamento', 72, 349.90, 18),
                    ( 'Fonte ATX 500W 80 Plus', 'Fonte ATX 500W certificada', 'Fontes de Alimentação', 52, 299.90, 19),
                    ( 'Gabinete Gamer com RGB', 'Gabinete gamer ATX com iluminação RGB', 'Gabinetes', 42, 399.90, 20),
                    ( 'Water Cooler 240mm', 'Water cooler para processador', 'Coolers', 28, 349.90, 21),
                    ( 'Mouse Gamer Redragon Cobra', 'Mouse gamer Redragon Cobra', 'Periféricos', 82, 159.90, 22),
                    ( 'Teclado Gamer Redragon Kumara', 'Teclado gamer Redragon Kumara', 'Teclados', 72, 279.90, 23),
                    ...
                    ( 'Scanner de Documentos', 'Scanner portátil de documentos', 'Impressão e Digitalização', 32, 499.90, 55),
                    ( 'Leitor de Cartão', 'Leitor de cartão SD/CF', 'Acessórios', 92, 59.90, 56),
                    ( 'Projetor Mini', 'Projetor mini portátil', 'Monitores', 22, 699.90, 57),
