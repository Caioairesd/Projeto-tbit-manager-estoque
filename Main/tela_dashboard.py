...
class tela_dashboard:
    ...
    def criar_widgets(self):
        ...
        voltar_menu_button.place(x=1775, y=1000)
        
        update_button = ctk.CTkButton(self.root, text='VOLTAR', width=90, height=40,fg_color='#0073E6', command=self.voltar_menu)
        update_button.place(x=1775, y=1000)
