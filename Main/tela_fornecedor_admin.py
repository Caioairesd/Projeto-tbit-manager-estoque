...
class tela_fornecedor_admin:
    ...
    def __init__(self,root):
        ...
        self.root.title("TBit Manager - Menu Fornecedor - Administrador")
    ...
    def create_widgets(self):
        ...
        #Criação de botões
        tk.Button(self.root,text="Alterar",width=15,height=1,command=self.update_fornecedor).place(x=200,y=280)
        tk.Button(self.root,text="Excluir",width=15,height=1,command=self.delete_fornecedor).place(x=400,y=280)
        tk.Button(self.root,text="Cancelar",width=15,height=1,command=self.cancelar_operacao).place(x=600,y=280)
